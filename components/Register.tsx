...
import { Eye, EyeOff, LogIn, Mail, AlertCircle, UserPlus, Lock } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-100 via-pink-50 to-indigo-100 p-4">
      <div className="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-xl p-8 transform transition-all hover:scale-[1.01]">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-4xl font-bold text-gray-900 mb-2">Buat Akun</h2>
          <p className="text-gray-600">Gunakan Todo App untuk mulai menjadi Produktif</p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-500">
                Minimal 8 karakter dengan 1 huruf besar, 1 huruf kecil, dan 1 angka
              </p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  {showConfirmPassword ? (
                    <EyeOff className="h-5 w-5" aria-label="Hide confirm password" />
                  ) : (
                    <Eye className="h-5 w-5" aria-label="Show confirm password" />
                  )}
                </button>
              </div>
            </div>
